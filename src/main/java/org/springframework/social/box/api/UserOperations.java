...
public interface UserOperations {
    ...
    /**
     * Retrieves all the information about the user who is currently logged in
     * i.e. the user for whom this auth token was generated.
     *
     * @return The {@link BoxUser} object.
     */
    public BoxUser getUserInformation();

    /**
     * Retrieves a subset of the information about the user who is currently
     * logged in i.e. the user for whom this auth token was generated. The
     * fields that can be used to define the subset are defined in
     * {@link BoxUserFields}
     *
     * @param fields
    ...
    /**
     * The available fields that can be used to define the subset of the user
     * information data ({@link BoxUser}) that will be retrieved from box.
     *
     * @author Ioannis Nikolaou
     */
